...
function App() {
  ...
  return (
    <div className='w-full h-full bg-cyan-900'>
      <div className='relative min-h-svh max-w-4xl m-auto flex flex-col gap-12 py-20 px-4'>
        <div className=' flex flex-col bg-cyan-800 text-cyan-200 shadow-xl rounded-md'>
          <div className='flex flex-col justify-center gap-2 p-8 '>
            <p className='font-bold text-xl font-sans pb-4'>Upload the zip file downloaded from instagram</p>
      ...
      {
        alert && <div className='absolute right-0 left-0 bottom-0 bg-green-100 w-auto min-h-12 m-4 flex justify-center items-center' >
          {alert}
        </div>}
    </div>
  );
